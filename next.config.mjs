...
const nextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: 'trunk.gallerycdn.vsassets.io',
      },
      {
        protocol: 'https',
  ...
  // Webpack personnalisé pour optimiser le bundle
  ...
  // Production source maps désactivées pour réduire la taille
